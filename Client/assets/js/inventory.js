document.addEventListener('DOMContentLoaded', () => {
  ...
  function setupStockForm() {
    ...
    document.getElementById('closeStockModal').onclick = () => modal.style.display = 'none';
  
    form.onsubmit = async (e) => {
      e.preventDefault();
      const id = document.getElementById('stockObjectId').value;
      const payload = {
        uniformCode: document.getElementById('stockCode').value,
        uniformSize: document.getElementById('stockSize').value,
        uniformColor: document.getElementById('stockColor').value,
